...
class ProductList(ListView): 
    model = Product
    template_name = 'shop/product_inline/product_list.html'
...
class RenderListTempMixin: 
    def get(self, request, *args, **kwargs): 
        ...
        data['list_temp'] = render_to_string('shop/product_inline/partial_product_list.html', context, request=request)
...
class RenderCreateTempMixin: 
    def get(self, request, *args, **kwargs): 
        ...
        data['create_temp'] = render_to_string('shop/product_inline/partial_product_create.html', context, request=request)
        return JsonResponse(data)
...
class RenderUpdateTempMixin: 
    def get(self, request, *args, **kwargs): 
        ...
        context = {'form': product_form, 'store': store}
        data['update_temp'] = render_to_string('shop/product_inline/partial_product_update.html', context, request=request)
        return JsonResponse(data)
...
class RenderDeleteTempMixin: 
    def get(self, request, *args, **kwargs): 
        ...
        product_form = ProductForm(instance=product_instance)
        context = {'form': product_form, 'store': store}
        data['delete_temp'] = render_to_string('shop/product_inline/partial_product_delete.html', context, request=request)
        return JsonResponse(data)
...
class RenderDetailTempMixin: 
    def get(self, request, *args, **kwargs): 
        ...
        data['detail_temp'] = render_to_string(
                'shop/product_inline/partial_product_detail.html', context, request=request
                )
        return JsonResponse(data)
